...
<div class="flex h-screen overflow-hidden">
    <aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-cyan-600 to-cyan-700 text-white flex flex-col z-40 transform -translate-x-full transition-transform duration-300 lg:relative lg:translate-x-0 lg:flex-shrink-0">
        ...
        <nav class="flex-1 py-4 px-3 space-y-0.5">
            ...
            <a href="/studentfeedbackucsh/student/feedback_forms.php" class="flex items-center gap-3 pl-3 pr-3 py-2.5 rounded-xl text-sm bg-white/20 text-white font-semibold"><?= iconSvg('clipboard','w-4 h-4 flex-shrink-0 text-emerald-300') ?> <?= $LANG['nav_feedback_forms'] ?? 'Feedback Forms' ?></a>
            <a href="/studentfeedbackucsh/student/feedback_history.php" class="flex items-center gap-3 pl-3 pr-3 py-2.5 rounded-xl text-sm text-cyan-100 hover:bg-white/10 hover:text-white"><?= iconSvg('history','w-4 h-4 flex-shrink-0 text-teal-300') ?> <?= $LANG['nav_history'] ?? 'Submission History' ?></a>
                            ...
                            <table class="w-full text-left border-collapse min-w-[500px]">
                                ...
                                <tbody class="text-xs divide-y divide-slate-200 text-slate-800">
                                    ...
                                    <tr class="hover:bg-slate-50/50 transition-colors">
                                        <td class="p-3 border-r border-slate-200 text-center font-bold font-mono text-lg"><?= e(displayQuestionNumber($q['question_no'], $_SESSION['lang'] ?? 'en')) ?></td>
